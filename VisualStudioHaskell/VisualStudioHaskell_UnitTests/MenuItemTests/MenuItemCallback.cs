...
namespace VisualStudioHaskell_UnitTests.MenuItemTests {
    ...
    public class MenuItemTest {
        ...
        public void InitializeMenuCommand() {
            ...
            CommandID menuCommandID = new CommandID(Company.VisualStudioHaskell.GuidList.guidVisualStudioHaskellCmdSet, (int)Company.VisualStudioHaskell.PkgCmdIDList.cmdidMyCommand);
