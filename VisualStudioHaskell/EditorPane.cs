...
namespace Company.VisualStudioHaskell
{
    ...
    //     - An empty hs file in the same directory as NewFileItems.vsdir. In
    //       our case we chose Main.hs. Note this file name appears in Editor.vsdir
    ...
    //          - "Main" - This is the base file name. New files will initially
    //             be named as Main1.hs, Main2.hs... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    Main.hs|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - Main.hs - our empty hs file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".hs";
        ...
        #region Fields
        private VisualStudioHaskellPackage myPackage;
        ...
        public EditorPane(VisualStudioHaskellPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the hs document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(VisualStudioHaskellPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVisualStudioHaskellCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVisualStudioHaskellCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVisualStudioHaskellEditorFactory;
            return VSConstants.S_OK;
        }
